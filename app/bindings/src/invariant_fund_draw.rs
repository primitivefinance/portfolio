...
pub mod invariant_fund_draw {
    ...
    pub static INVARIANTFUNDDRAW_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
    });
    /// Bytecode of the #name contract
    pub static INVARIANTFUNDDRAW_BYTECODE: ::ethers::contract::Lazy<
    ...
    impl<M> std::fmt::Debug for InvariantFundDraw<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(InvariantFundDraw)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> InvariantFundDraw<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<M, InvariantFundDrawEvents> {
    ...
    impl ::std::fmt::Display for InvariantFundDrawEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                InvariantFundDrawEvents::LogNamedDecimalIntFilter(element) => {
                    element.fmt(f)
                }
                InvariantFundDrawEvents::LogNamedDecimalUintFilter(element) => {
                    element.fmt(f)
                }
    ...
    impl ::ethers::core::abi::AbiDecode for InvariantFundDrawCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <FundAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                ) {
                return Ok(InvariantFundDrawCalls::FundAsset(decoded));
            }
            if let Ok(decoded)
                = <FundQuoteCall as ::ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for InvariantFundDrawCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                InvariantFundDrawCalls::GetPositionLiquiditySum(element) => {
                    element.encode()
                }
