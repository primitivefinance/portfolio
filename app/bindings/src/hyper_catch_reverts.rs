...
pub mod hyper_catch_reverts {
    ...
    pub static HYPERCATCHREVERTS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    /// Bytecode of the #name contract
    pub static HYPERCATCHREVERTS_BYTECODE: ::ethers::contract::Lazy<::ethers::core::types::Bytes> =
        ::ethers::contract::Lazy::new(|| {
    ...
    impl<M> std::fmt::Debug for HyperCatchReverts<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(HyperCatchReverts))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HyperCatchReverts<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, HyperCatchRevertsEvents> {
    ...
    impl ::ethers::core::abi::AbiEncode for HyperCatchRevertsErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                HyperCatchRevertsErrors::InsufficientPosition(element) => element.encode(),
    ...
    impl ::ethers::contract::EthLogDecode for HyperCatchRevertsEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DecreaseReserveBalanceFilter::decode_log(log) {
                return Ok(HyperCatchRevertsEvents::DecreaseReserveBalanceFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = IncreaseReserveBalanceFilter::decode_log(log) {
                return Ok(HyperCatchRevertsEvents::IncreaseReserveBalanceFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for HyperCatchRevertsEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                HyperCatchRevertsEvents::ChangeParametersFilter(element) => element.fmt(f),
                ...
                HyperCatchRevertsEvents::DecreaseReserveBalanceFilter(element) => element.fmt(f),
                HyperCatchRevertsEvents::DecreaseUserBalanceFilter(element) => element.fmt(f),
                HyperCatchRevertsEvents::DepositFilter(element) => element.fmt(f),
                HyperCatchRevertsEvents::IncreaseReserveBalanceFilter(element) => element.fmt(f),
                HyperCatchRevertsEvents::IncreaseUserBalanceFilter(element) => element.fmt(f),
    ...
    impl ::ethers::core::abi::AbiDecode for HyperCatchRevertsCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <DoJumpProcessCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
            ...
            if let Ok(decoded) =
                <JitDelayCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(HyperCatchRevertsCalls::JitDelay(decoded));
            }
            if let Ok(decoded) =
                <JumpProcessCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(HyperCatchRevertsCalls::JumpProcess(decoded));
            }
            if let Ok(decoded) =
                <MockFallbackCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
            ...
            if let Ok(decoded) =
                <SetJitPolicyCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
            ...
            if let Ok(decoded) =
                <TimestampCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
