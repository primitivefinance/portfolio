...
pub mod hyper_time_override {
    ...
    pub static HYPERTIMEOVERRIDE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    /// Bytecode of the #name contract
    pub static HYPERTIMEOVERRIDE_BYTECODE: ::ethers::contract::Lazy<::ethers::core::types::Bytes> =
        ::ethers::contract::Lazy::new(|| {
    ...
    impl<M> std::fmt::Debug for HyperTimeOverride<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(HyperTimeOverride))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HyperTimeOverride<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, HyperTimeOverrideEvents> {
    ...
    impl ::ethers::core::abi::AbiEncode for HyperTimeOverrideErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                HyperTimeOverrideErrors::InsufficientPosition(element) => element.encode(),
    ...
    impl ::ethers::contract::EthLogDecode for HyperTimeOverrideEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DecreaseReserveBalanceFilter::decode_log(log) {
                return Ok(HyperTimeOverrideEvents::DecreaseReserveBalanceFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = IncreaseReserveBalanceFilter::decode_log(log) {
                return Ok(HyperTimeOverrideEvents::IncreaseReserveBalanceFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for HyperTimeOverrideEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                HyperTimeOverrideEvents::ChangeParametersFilter(element) => element.fmt(f),
                ...
                HyperTimeOverrideEvents::DecreaseReserveBalanceFilter(element) => element.fmt(f),
                HyperTimeOverrideEvents::DecreaseUserBalanceFilter(element) => element.fmt(f),
                HyperTimeOverrideEvents::DepositFilter(element) => element.fmt(f),
                HyperTimeOverrideEvents::IncreaseReserveBalanceFilter(element) => element.fmt(f),
                HyperTimeOverrideEvents::IncreaseUserBalanceFilter(element) => element.fmt(f),
