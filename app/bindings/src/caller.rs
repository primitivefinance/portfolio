...
pub mod caller {
    ...
    pub static CALLER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    /// Bytecode of the #name contract
    pub static CALLER_BYTECODE: ::ethers::contract::Lazy<::ethers::core::types::Bytes> =
        ::ethers::contract::Lazy::new(|| {
    ...
    impl<M> std::fmt::Debug for Caller<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(Caller))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for Caller<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for CallerCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <ForwardCall as ::ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
