...
pub mod helper_hyper_view {
    ...
    pub static HELPERHYPERVIEW_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi"));
    /// Bytecode of the #name contract
    pub static HELPERHYPERVIEW_BYTECODE: ::ethers::contract::Lazy<
    ...
    impl<M> std::fmt::Debug for HelperHyperView<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(HelperHyperView)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiEncode for HelperHyperViewCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                HelperHyperViewCalls::GetPositionLiquiditySum(element) => {
                    element.encode()
                }
