...
pub mod hyper_tau {
    ...
    pub static HYPERTAU_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> std::fmt::Debug for HyperTau<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(HyperTau))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HyperTau<M> {
