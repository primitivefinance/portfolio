...
pub mod invariant_create_pool {
    ...
    pub static INVARIANTCREATEPOOL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> InvariantCreatePool<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, InvariantCreatePoolEvents> {
    ...
    impl ::ethers::contract::EthLogDecode for InvariantCreatePoolEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(InvariantCreatePoolEvents::LogNamedDecimalUintFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for InvariantCreatePoolEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                InvariantCreatePoolEvents::LogNamedAddressFilter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedArray1Filter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedArray2Filter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedArray3Filter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedBytesFilter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedBytes32Filter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedDecimalIntFilter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedDecimalUintFilter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedIntFilter(element) => element.fmt(f),
                InvariantCreatePoolEvents::LogNamedStringFilter(element) => element.fmt(f),
    ...
    impl ::ethers::core::abi::AbiEncode for InvariantCreatePoolCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                InvariantCreatePoolCalls::GetPositionLiquiditySum(element) => element.encode(),
    ...
    impl ::std::fmt::Display for InvariantCreatePoolCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                InvariantCreatePoolCalls::GetPositionLiquiditySum(element) => element.fmt(f),
