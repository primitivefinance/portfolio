...
pub mod invariant_warper {
    ...
    pub static INVARIANTWARPER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi"));
    /// Bytecode of the #name contract
    pub static INVARIANTWARPER_BYTECODE: ::ethers::contract::Lazy<
    ...
    impl<M> std::fmt::Debug for InvariantWarper<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(InvariantWarper)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> InvariantWarper<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<M, InvariantWarperEvents> {
    ...
    impl ::std::fmt::Display for InvariantWarperEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                InvariantWarperEvents::LogNamedDecimalIntFilter(element) => {
                    element.fmt(f)
                }
                InvariantWarperEvents::LogNamedDecimalUintFilter(element) => {
                    element.fmt(f)
                }
    ...
    impl ::ethers::core::abi::AbiDecode for InvariantWarperCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <WarpAfterMaturityCall as ::ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for InvariantWarperCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                InvariantWarperCalls::GetPositionLiquiditySum(element) => {
                    element.encode()
                }
