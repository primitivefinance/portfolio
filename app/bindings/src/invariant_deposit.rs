...
pub mod invariant_deposit {
    ...
    pub static INVARIANTDEPOSIT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    /// Bytecode of the #name contract
    pub static INVARIANTDEPOSIT_BYTECODE: ::ethers::contract::Lazy<::ethers::core::types::Bytes> =
        ::ethers::contract::Lazy::new(|| {
    ...
    impl<M> std::fmt::Debug for InvariantDeposit<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(InvariantDeposit))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> InvariantDeposit<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<M, InvariantDepositEvents> {
    ...
    impl ::std::fmt::Display for InvariantDepositEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                InvariantDepositEvents::LogNamedDecimalIntFilter(element) => element.fmt(f),
                InvariantDepositEvents::LogNamedDecimalUintFilter(element) => element.fmt(f),
    ...
    impl ::ethers::core::abi::AbiEncode for InvariantDepositCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                InvariantDepositCalls::GetPositionLiquiditySum(element) => element.encode(),
