...
contract RMM02Portfolio is PortfolioVirtual {
        ...
        returns (bool, int256)
    {
        ...
        bool valid = true;
        int256 invariant =
            pool.invariantOf(pool.virtualX, pool.virtualY, weight);
    ...
    function checkInvariant(
        ...
        nextInvariant = pools[poolId].invariantOf({
            R_x: reserveX,
            R_y: reserveY,
            weight: weight
    ...
    function computeReservesFromPrice(
        ...
        (reserveX, reserveY) =
            pools[poolId].computeReservesWithPrice(price, weight, balance);
    }
    ...
    function getAmountOut(
        ...
        output = pools[poolId].getAmountOut({
            sellAsset: sellAsset,
            amountIn: amountIn,
            weightIn: weight
        });
